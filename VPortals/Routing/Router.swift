...
protocol RouterProtocol {
    ...
    func navigateToLoginViewControllerWithLoginAction(loginHandler:@escaping(_ PortalNumber: String, _ UserName: String, _ Password: String) ->Void)
...
class VPortalsLoginRouter: RouterProtocol {
    ...
    func navigateToLoginViewControllerWithLoginAction(loginHandler: @escaping (String, String, String) -> Void) {
